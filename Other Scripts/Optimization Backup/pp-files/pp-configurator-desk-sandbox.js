		...
		var configurator = {
				...
				createInterface: function(model_data){
					...
					this.table = {
						...
						btn_tw: 		$j('<a></a>').attr({'href': '#'}).html('<iframe scrolling="no" frameborder="0" allowtransparency="true" src="http://platform.twitter.com/widgets/tweet_button.1347008535.html#_=1350670437261&amp;count=none&amp;counturl=http%3A%2F%2Fsandbox.poppin.com%2FDesign-A-Desk_3.html&amp;id=twitter-widget-0&amp;lang=en&amp;original_referer=http%3A%2F%2Fsandbox.poppin.com%2FDesign-A-Desk_3.html&amp;size=m&amp;text=Design%20a%20Desk&amp;url=http%3A%2F%2Fsandbox.poppin.com%2FDesign-A-Desk_3.html&amp;via=poppin" class="twitter-share-button twitter-count-none" style="width: 59px; height: 20px;" title="Twitter Tweet Button" data-twttr-rendered="true"></iframe>'),
					...
					var cart_top_message 		= $j('<span></span>').addClass('cart-top-message').text(settings.cartMessageTop);
				...
				controller: function(view){
					return actions = {
						...
						setSocialPlugin: function(){
							...
							var p_id = '46';
							var p_url = 'http://sandbox.poppin.com/Design-A-Desk_3.html';
							var p_desc = settings.cartDefaultText;
							var domain = 'http://www.poppin.com/';
							var current_domain = 'http://sandbox.poppin.com';
							var current_domain_name = 'sandbox.poppin.com';
							var origin = 'http://sandbox.poppin.com/f24695159ac25fa';
							
							if(social_name == 'fb'){
								
								var fb =		'http://static.ak.facebook.com/connect/xd_arbiter.php?'+
												'version=11#cb=f2ad75c403e573c'+
												'&origin='+encodeURIComponent(origin)+
												'&domain='+current_domain_name+
												'&relation=opener'+
												'&frame=f29ba84e9e492a8'+
												'&result=%22xxRESULTTOKENxx%22';
								
								var fb_url = 	'http://www.facebook.com/dialog/feed?api_key=139313082868948&app_id=139313082868948'+
