...
function getLeadSource() {
	...
	if(result != '') {
		...
		case '17':
			...
			break;
		case '18':
			result = '18 B2B_Paid Search_NoOffer';
			break;
		case '19':
			result = '19 B2B_Paid Search_Offer';
			break;
		case '23':
			result = '23 B2B_LiveIntent_NoOffer';
			break;
		default: //16
...
function campaignCheck() {
	var //regex = /[?&]([^=#]+)=([^&#]*)/g,
		...
		_form_url = 'http://www.poppin.com/app/site/crm/externalleadpage.nl?compid=3363929&formid=28&h=4d621c35d31af00862be&leadsource='+_leadsource,
	...
	switch (match) {
		case 'FB2':
			...
			$(".call-us").css("background-image", "url(http://www.poppin.com/site/pp-sources/workhappy/call_.jpg)");
			break;
		case 'SE2':
		...
		case 'SE1':
			...
			break;
		case 'LI1':
			_label = 'B2B_LiveIntent_NoOffer';
			_phoneNumber = '(888) 995-5136';
			$(".cat-heading p strong:contains('Desk Accessories + Office Essentials:')").text("Office Essentials:");
			break;
		default: //FB1
