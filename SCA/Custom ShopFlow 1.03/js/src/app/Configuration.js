...
(function (application)
{
	...
	,	navigationTabs: [
		...
		,	{
			text: _('Desk Accessories').translate()
		,	href: '/Desk-Accessories_7'
		,	data: {
				touchpoint: 'home'
			,	hashtag: '#Desk-Accessories_7'
			}
		}
		,	{
		...
		,	data: {
				touchpoint: 'home'
			,	hashtag: '#Furniture_10'
			}
		}
		,	{
			text: _('Tech Accessories').translate()
		,	href: '/Tech_5'
		,	data: {
				touchpoint: 'home'
			,	hashtag: '#Tech_5'
